...
import { getProfiles, searchProfiles } from "../services/profiles.service";
...
const Search = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      const response: any = await searchProfiles(filters);
          ...
          <div className="p-6 border-b border-zinc-200">
            <div className="flex flex-col md:flex-row md:items-end gap-4 mb-6">
              ...
              <button
                ...
                className={`
      flex items-center justify-center px-4 py-2 rounded-lg transition
      ${
        searchText.trim()
